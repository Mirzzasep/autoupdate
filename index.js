...
<tg-emoji emoji-id="4956726373679891220">🍽</tg-emoji>Version    : 7.0
...
<blockquote><b>━━━━━━━━━━━━━━━━━━━━━━
( 👁️ ) Holla ${firstName}
Selamat datang di 𝗩𝗢𝗖 𝗣𝗥𝗢𝗝𝗘𝗖𝗧 𝗠𝗗 2.0 Owner @Mirzzxkntll
...
bot.on("callback_query", async (query) => {
  ...
  if (data.startsWith("color_")) {
    ...
    if (data === "trashmenu") {
      selectedImage = "https://d.top4top.io/p_37224iria0.png"; // Ganti dengan link foto menu bugs
...
`;
      ...
      selectedImage = "https://d.top4top.io/p_37224iria0.png"; // Ganti dengan link foto menu owner
...
`;
      ...
      selectedImage = "https://d.top4top.io/p_37224iria0.png"; // Ganti dengan link foto menu tools
...
bot.on('poll_answer', async (pollAnswer) => {
  try {
    ...
    const bugTypes = ["Chatms", "Douwes", "Quiksilver", "xploit", "Ganesha"]
